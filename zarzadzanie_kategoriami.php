...
<div class="menu">
  ...
  <a href="zarzadzanie_platnosciami.php" class="A">Dostawa i płatność</a>
...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script>
    ...
    if(isset($_POST['submit']) && $_POST['search']!=''){
        $stmt = $pdo->prepare("SELECT * FROM kategoria WHERE kategoria LIKE :kategoria");
        $stmt -> bindValue(':kategoria', '%'.$_POST['search'].'%', PDO::PARAM_STR);
        $stmt->execute();
    }else{
...
<center>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <table id="table">
                    ...
                    foreach ($stmt as $row){
                      include('baza.php');
                      $query=mysqli_query($conn,"select * from `kategoria`");
                        ...
                        <td><?php echo $row['id_kategorii']; ?></td>
                          ...
                          <td style="background-color:white;">
                            <a id="modyfikacja" href="zarzadzanie_kategoriami_form.php?id=<?php echo $row['id_kategorii']; ?>">MODYFIKUJ</a>
                            <a id="usuwanie" href="zarzadzanie_kategoriami_us.php?id=<?php echo $row['id_kategorii']; ?>">✖</a>
                          </td>
                        </tr>
    ...
    <a id="dodawanie" href="zarzadzanie_kategoriami_form_dod.php?id=<?php echo $row['id_kategorii']; ?>">DODAJ</a>
            </div>
        </div>
    </div>
