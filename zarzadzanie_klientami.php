...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script>
    ...
    if(isset($_POST['submit']) && $_POST['search']!=''){
        $stmt = $pdo->prepare("SELECT * FROM klienci WHERE imie LIKE :imie OR nazwisko LIKE :nazwisko OR login LIKE :login");
            ...
            <div class="col-12">
                ...
                <table id="table">
                    ...
                    <tr>
                        ...
                        <th>Adres e-mail</th>
                        <th>Login</th>
                        <th style="width:150px;">Notatka</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    foreach ($stmt as $row){
                      ...
                      $query=mysqli_query($conn,"select * from `klienci`");
                        ...
                        <td><?php echo $row['ID_klient']; ?></td>
                          ...
                          <td><?php echo $row['notatka']; ?></td>
                          <td style="background-color:white;">
                            <a id="modyfikacja" href="zarzadzanie_klientami_form.php?id=<?php echo $row['ID_klient']; ?>">MODYFIKUJ</a>
                            <a id="notatka" href="zarzadzanie_klientami_form_notatka.php?id=<?php echo $row['ID_klient']; ?>">NOTATKA</a>
                          </td>
                        </tr>
                        <?php
