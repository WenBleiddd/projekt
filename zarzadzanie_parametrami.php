...
<center>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <table id="table">
                    ...
                    foreach ($stmt as $row){
                      include('baza.php');
                      $query=mysqli_query($conn,"select * from `parametry`");
                      
                        ?>
                        <tr>
                        <td><?php echo $row['id_parametrow']; ?></td>
                          <td><?php echo $row['parametry']; ?></td>
                          <td><?php echo $row['id_produktu']; ?></td>
                          <td style="background-color:white;">
                            <a id="modyfikacja" href="zarzadzanie_parametrami_form.php?id=<?php echo $row['id_parametrow']; ?>">MODYFIKUJ</a>
                            <a id="usuwanie" href="zarzadzanie_parametrami_us.php?id=<?php echo $row['id_parametrow']; ?>">✖</a>
                          </td>
                        </tr>
    ...
    <a id="dodawanie" href="zarzadzanie_parametrami_form_dod.php?id=<?php echo $row['id_parametrow']; ?>">DODAJ</a>
            </div>
        </div>
    </div>
...
<center>
    ...
    <a id="dodawanie" href="zarzadzanie_parametrami_form_dod.php">DODAJ</a>
            </div>
        </div>
    </div>
